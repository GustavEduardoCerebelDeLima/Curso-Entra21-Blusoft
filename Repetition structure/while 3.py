...
acao = ["9780439951784 Northern Lights", "9788556510686  A Máquina do Tempo", "9788578270698  As Crônicas de Nárnia", "9788576164081 Lugar Nenhum", "9788595084742 O Hobbit",
...
while True:
    print(50*"-")
    recomendacao = str(input("\33[4:33m[1] Recomendação de Livro\n[2] Validar ISBN\n\33[m"))
    if recomendacao == "1":
        print(50 * "-")
        print("\33[4:33mRecomendação de Livros\33[m")
...
[5] Terror (Recomendação de Cauan)""")
        ...
        if escolha == "1":
            ...
            escolha_aleatoria = random.choice(romance)
            print(f"Sua recomendação é:{escolha_aleatoria[13:]}")
        elif escolha == "3":
        ...
        if len(isbn_lista) > 13:
            ...
            exit()
        elif len(isbn_lista) < 13:
            print("\33[4:31mCaracterias do ISBN insuficiente!\33[m")
            exit()
    else:
        print("Opção Invalida!")
        exit()
    ...
    if verificacao == 0:
        ...
        try:
            ...
            print()
            print(50 * "-")
            informacao = str(input("\33[4:33m\nDesejas mais informações?\n[1] Sim\n[2] Não\n\33[m"))
            print(50 * "-")
            if informacao == "1":
                webbrowser.open(f"https://www.amazon.com.br/s?k={isbn[0:13]}")
        except:
            informacao = str(input("\33[4:33mDeseja informação sobre o livro?\n[1] Sim\n[2] Não\n\33[m"))
            if informacao == "1":
                webbrowser.open(f"https://www.amazon.com.br/s?k={isbn[0:13]}")
                print(50 * "-")
            else:
    ...
    saida = str(input("\33[4:33m[1] Deseja continuar\n[2] Deseja parar\n\33[m"))
    if saida != "1":
        break